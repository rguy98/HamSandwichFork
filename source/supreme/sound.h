...
#define SND_MONEY		(SND_MYSTIC_START + 156)
#define SND_ATTACKED	(SND_MYSTIC_START + 157)
#define SND_FIRECAST	(SND_MYSTIC_START + 21)		//kid mystic cast fireball

#define SND_WALLDOWNKM	(SND_MYSTIC_START + 29)
#define SND_WALLUPKM	(SND_MYSTIC_START + 30)
#define SND_MESSAGEKM	(SND_MYSTIC_START + 35)
#define SND_FIREUPKM	(SND_MYSTIC_START + 78)
#define SND_POWERKM		(SND_MYSTIC_START + 79)
#define SND_WEAPONKM	(SND_MYSTIC_START + 82)
#define SND_MANAPOTION	(SND_MYSTIC_START + 83)
#define SND_KEYCHAINKM	(SND_MYSTIC_START + 87)
#define SND_LIFEPOTION	(SND_MYSTIC_START + 88)
#define SND_DOOROPENKM	(SND_MYSTIC_START + 92)
#define SND_FBREFLECT	(SND_MYSTIC_START + 6)
#define SND_BULLETKM	(SND_MYSTIC_START + 18)

#define SND_PTEROSHOOT	(SND_MYSTIC_START + 159)
#define SND_PTERODIE	(SND_MYSTIC_START + 160)
#define SND_PTEROSUMMON	(SND_MYSTIC_START + 161)
#define SND_BIGRUMBLE	(SND_MYSTIC_START + 174)

#define SND_FAIRYGET		(SND_MYSTIC_START + 215)
#define SND_REVIVEKM		(SND_MYSTIC_START + 222)
#define SND_KMBUY			(SND_MYSTIC_START + 223)
#define SND_KMNOBUY			(SND_MYSTIC_START + 224)
#define SND_CHLGCRYSTAL		(SND_MYSTIC_START + 236)
#define SND_ALLCHLGCRYSTAL	(SND_MYSTIC_START + 237)
#define SND_FROZEN			(SND_MYSTIC_START + 163)
#define SND_ICEBEAM			(SND_MYSTIC_START + 164)
#define SND_BESERK			(SND_MYSTIC_START + 165)
#define SND_STONESKIN		(SND_MYSTIC_START + 166)
#define SND_INFERNAL		(SND_MYSTIC_START + 167)
...
#define SND_BOBBYLAUGH	(SND_MYSTIC_START + 199)
//back to eye guy
...
#define SND_INCADIE2	(SND_MYSTIC_START + 220)
#define SND_INCATONGUE	(SND_MYSTIC_START + 221)
//snail
...
#define SND_MADCOWBUMP	(SND_SLEEPLESS_START + 185)
#define SND_BOBHIT		(SND_SLEEPLESS_START + 22)
#define SND_FISHCAUGHT	(SND_SLEEPLESS_START + 23)
#define SND_FROGOUCH	(SND_SLEEPLESS_START + 58)
#define SND_FROGDIE		(SND_SLEEPLESS_START + 59)
#define SND_FROGLICK	(SND_SLEEPLESS_START + 60)
#define SND_SPOOKSHIFT	(SND_SLEEPLESS_START + 161)
#define SND_SPOOKOUCH	(SND_SLEEPLESS_START + 109)
#define SND_SPOOKDIE	(SND_SLEEPLESS_START + 110)
#define SND_HORSERATK	(SND_SLEEPLESS_START + 155)
#define SND_SHWALLDWN	(SND_SLEEPLESS_START + 29)
#define SND_SHWALLUP	(SND_SLEEPLESS_START + 30)
#define SND_SPARK		(SND_SLEEPLESS_START + 121)
#define SND_SHBELL		(SND_SLEEPLESS_START + 319)
#define SND_SHSPOOKY	(SND_SLEEPLESS_START + 314)
#define SND_SHLEVELUP	(SND_SLEEPLESS_START + 3)
#define SND_SHWEPONUP	(SND_SLEEPLESS_START + 4)
#define SND_FISHCAST	(SND_SLEEPLESS_START + 15)
#define SND_BOBSPLASH	(SND_SLEEPLESS_START + 16)
#define SND_BOBHIT	(SND_SLEEPLESS_START + 22)
#define SND_FISHCAUGHT	(SND_SLEEPLESS_START + 23)
