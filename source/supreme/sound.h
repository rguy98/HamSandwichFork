...
#define SND_BATDIE		(SND_LOONYLAND_START + 14)
// eensy weensy spider
...
#define SND_SEKRIT		336
#define SND_SZLEAP		337
#define SND_SZOUCH		338
#define SND_SZDIE		339
#define SND_BEAM2		340
#define SND_SPHINXHURT	341
#define SND_SPHINXDIE	342
#define SND_YERFOUCH	343
#define SND_YERFLEAVE	344
#define SND_PUMPKINOUCH	345
#define SND_HOLOLAUGH	346
#define SND_HOLOSHOOT	347
#define SND_HOLOOUCH	348
#define SND_HOLODIE		349
#define SND_SDZLSUMMON	350
#define SND_EMPRESSHEAD	351
#define SND_EMPRESSSPWN	352
...
// Loonyland sounds
#define SND_SKEL2OUCH	(SND_LOONYLAND_START + 0)
#define SND_SKEL2DIE	(SND_LOONYLAND_START + 1)
#define SND_SKEL2KICK	(SND_LOONYLAND_START + 2)
#define SND_SKEL2SHOOT	(SND_LOONYLAND_START + 3)
#define SND_SKELGAS		(SND_LOONYLAND_START + 4)
#define SND_SKELSUMMON	(SND_LOONYLAND_START + 5)
#define SND_SKELBLAST	(SND_LOONYLAND_START + 6)
#define SND_ZOMBIE2OUCH	(SND_LOONYLAND_START + 7)
#define SND_ZOMBIE2DIE	(SND_LOONYLAND_START + 8)
#define SND_ZOMBIE2LEAP	(SND_LOONYLAND_START + 9)
#define SND_ZOMBIESTOMP	(SND_LOONYLAND_START + 10)
#define SND_LOONYOUCH	(SND_LOONYLAND_START + 11)
#define SND_LOONYDIE	(SND_LOONYLAND_START + 12)
#define SND_LOONYSHOOT	(SND_LOONYLAND_START + 13)
#define SND_LOONYBORED	(SND_LOONYLAND_START + 14)
#define SND_VILLAGERSCRATCH	(SND_LOONYLAND_START + 15)
#define SND_VILLAGERYAWN	(SND_LOONYLAND_START + 16)
#define SND_VILLAGERHELLO	(SND_LOONYLAND_START + 17)
#define SND_VILLAGERHELLO2	(SND_LOONYLAND_START + 18)
#define SND_VILLAGERHELLO3	(SND_LOONYLAND_START + 19)
#define SND_STEAM		(SND_LOONYLAND_START + 23)
#define SND_MUMMYSMACK	(SND_LOONYLAND_START + 24)
...
#define SND_TREESUMMON	(SND_LOONYLAND_START + 28)
#define SND_BAT2OUCH	(SND_LOONYLAND_START + 29)
#define SND_BAT2EYES	(SND_LOONYLAND_START + 31)
#define SND_BATSHOOT	(SND_LOONYLAND_START + 32)
#define SND_BAT2DIVE	(SND_LOONYLAND_START + 33)
#define SND_WOLFSPIT	(SND_LOONYLAND_START + 36)
...
#define SND_GHOST2OUCH	(SND_LOONYLAND_START + 46)
#define SND_GHOST2DIE	(SND_LOONYLAND_START + 47)
#define SND_GHOSTSPIN	(SND_LOONYLAND_START + 48)
#define SND_GHOSTPUNCH	(SND_LOONYLAND_START + 49)
#define SND_GHOST2SCREAM	(SND_LOONYLAND_START + 50)
#define SND_GHOST2TELEPORT	(SND_LOONYLAND_START + 51)
#define SND_VAMPSUMMON	(SND_LOONYLAND_START + 52)
#define SND_VAMPSHOOT	(SND_LOONYLAND_START + 53)
#define SND_STKWITCHOUCH	(SND_LOONYLAND_START + 54)
#define SND_STKWITCHDIE		(SND_LOONYLAND_START + 55)
#define SND_STKWITCHATK		(SND_LOONYLAND_START + 56)
#define SND_BLOCKPUSHLL	(SND_LOONYLAND_START + 57)
#define SND_LLQUESTBEGIN	(SND_LOONYLAND_START + 58)
#define SND_LLQUESTEND	(SND_LOONYLAND_START + 59)
#define SND_LLENTERMAP	(SND_LOONYLAND_START + 60)
#define SND_WHOOPEE1	(SND_LOONYLAND_START + 61)
#define SND_WHOOPEE2	(SND_LOONYLAND_START + 62)
#define SND_WHOOPEE3	(SND_LOONYLAND_START + 63)
#define SND_CACTUS		(SND_LOONYLAND_START + 64)
#define SND_LLPOWERUP	(SND_LOONYLAND_START + 65)
#define SND_LLHEAL		(SND_LOONYLAND_START + 66)
#define SND_MEOW		(SND_LOONYLAND_START + 67)
#define SND_GRATEOPEN	(SND_LOONYLAND_START + 68)
#define SND_MUSHGET		(SND_LOONYLAND_START + 69)
#define SND_LLWEAPON	(SND_LOONYLAND_START + 70)
#define SND_GEMGET		(SND_LOONYLAND_START + 72)
#define SND_CLEARCRYPT	(SND_LOONYLAND_START + 73)
#define SND_LLDOOROPEN	(SND_LOONYLAND_START + 74)
#define SND_LLKEYGET	(SND_LOONYLAND_START + 75)
#define SND_LLSWITCH	(SND_LOONYLAND_START + 76)
#define SND_LLSWITCH2	(SND_LOONYLAND_START + 77)
#define SND_STONEBONK	(SND_LOONYLAND_START + 79)
#define SND_PLANTGROW	(SND_LOONYLAND_START + 80)
#define SND_LIGHTSMACK	(SND_LOONYLAND_START + 81)
#define SND_LLBOOM		(SND_LOONYLAND_START + 82)
#define SND_BIGBOOM		(SND_LOONYLAND_START + 83)
#define SND_AUTODOOROPEN	(SND_LOONYLAND_START + 84)
#define SND_AUTODOORSHUT	(SND_LOONYLAND_START + 85)
...
#define SND_POLTERGET	(SND_LOONYLAND_START + 94)
#define SND_GRENADE		(SND_LOONYLAND_START + 95)
#define SND_LLSAVE		(SND_LOONYLAND_START + 96)
#define SND_LLLOAD		(SND_LOONYLAND_START + 97)
#define SND_LLPAUSE		(SND_LOONYLAND_START + 98)
#define SND_PUMPKIN2OUCH	(SND_LOONYLAND_START + 99)
#define SND_PUMPKIN2DIE		(SND_LOONYLAND_START + 100)
#define SND_VAMP2OUCH		(SND_LOONYLAND_START + 101)
#define SND_VAMP2DIE		(SND_LOONYLAND_START + 102)
#define SND_VAMPSHOVE		(SND_LOONYLAND_START + 103)
#define SND_MUMMYSHOOT		(SND_LOONYLAND_START + 104)
#define SND_LLZAP			(SND_LOONYLAND_START + 105)
...
#define SND_LLBUBBLEPOP		(SND_LOONYLAND_START + 111)
#define SND_LLFREEZE		(SND_LOONYLAND_START + 112)
#define SND_FILMLOOP		(SND_LOONYLAND_START + 113)
#define SND_VILLDIE1		(SND_LOONYLAND_START + 114)
#define SND_VILLDIE2		(SND_LOONYLAND_START + 115)
...
#define SND_BONKHURRY		(SND_LOONYLAND_START + 120)
#define SND_BONKHURRY2		(SND_LOONYLAND_START + 121)
#define SND_WITCHTAUNT		(SND_LOONYLAND_START + 122)
#define SND_LLBADGEGET		(SND_LOONYLAND_START + 123)
#define SND_LLSCARYBOSS		(SND_LOONYLAND_START + 124)
#define SND_FWORK			(SND_LOONYLAND_START + 125)
#define SND_FWORK2			(SND_LOONYLAND_START + 126)
#define SND_CRUMP			(SND_LOONYLAND_START + 127)
#define SND_CRUMP2			(SND_LOONYLAND_START + 128)
#define SND_PENALTYVC		(SND_LOONYLAND_START + 129)
#define SND_PENALTYOPEN		(SND_LOONYLAND_START + 130)
#define SND_GOALVOICE		(SND_LOONYLAND_START + 131)
#define SND_CHEERING		(SND_LOONYLAND_START + 132)
#define SND_BALLKICK		(SND_LOONYLAND_START + 133)
#define SND_BALLBOUNCE		(SND_LOONYLAND_START + 134)
#define SND_BALLDRIBBLE		(SND_LOONYLAND_START + 135)
#define SND_LLMODEGET		(SND_LOONYLAND_START + 136)
#define SND_WITCHOUT		(SND_LOONYLAND_START + 137)
#define SND_MAGICUP			(SND_LOONYLAND_START + 138)
#define SND_CATMAD			(SND_LOONYLAND_START + 141)
#define SND_WATERSPURT		(SND_LOONYLAND_START + 144)
#define SND_WATERSPLASH		(SND_LOONYLAND_START + 145)
#define SND_LLHISCORE		(SND_LOONYLAND_START + 146)
#define SND_LLMENUCLICK		(SND_LOONYLAND_START + 147)
#define SND_LLMENUSELECT	(SND_LOONYLAND_START + 148)
#define SND_LLMENUCANCEL	(SND_LOONYLAND_START + 149)
#define SND_FRANKOUCH2		(SND_LOONYLAND_START + 150)
#define SND_GRAVESMASH		(SND_LOONYLAND_START + 151)
#define SND_CATTAILSMASH	(SND_LOONYLAND_START + 152)
#define SND_EVILIZER		(SND_LOONYLAND_START + 153)
#define SND_METALSMACK		(SND_LOONYLAND_START + 154)
#define SND_BUZZSAW			(SND_LOONYLAND_START + 155)
#define SND_WITCHSPEED		(SND_LOONYLAND_START + 156)
#define SND_FROGSPLAT		(SND_LOONYLAND_START + 157)
#define SND_LOONYFLY		(SND_LOONYLAND_START + 158)
#define SND_MINIRIBBIT		(SND_LOONYLAND_START + 159)
#define SND_LOONYSPLAT		(SND_LOONYLAND_START + 160)
#define SND_MOVIELICK		(SND_LOONYLAND_START + 161)
#define SND_EVILSPLAT		(SND_LOONYLAND_START + 162)
#define SND_EVILFALL		(SND_LOONYLAND_START + 163)
#define SND_THUMBSUP		(SND_LOONYLAND_START + 164)
#define SND_LOONYOOF		(SND_LOONYLAND_START + 165)
#define SND_LLENDSTING		(SND_LOONYLAND_START + 166)
#define SND_WITCHBORED		(SND_LOONYLAND_START + 167)
#define SND_SWAMPGURGLE		(SND_LOONYLAND_START + 168) // 168-72
#define SND_CLIFFSWIND		(SND_LOONYLAND_START + 173) // 173-77
#define SND_WOODSLIFE		(SND_LOONYLAND_START + 178) // 178-82
...
#define SND_LARRYNORMAL		(SND_LOONYLAND_START + 187)
#define SND_HOTPANTS		(SND_LOONYLAND_START + 188)
