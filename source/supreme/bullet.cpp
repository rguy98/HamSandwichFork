...
void BulletHitFloor(bullet_t *me,Map *map,world_t *world)
{
	...
	switch(me->type)
	{
		...
		case BLT_COMETBOOM:
			...
			break;
		case BLT_SPOREBALL: // occasionally used
			Dribble(me);
			break;
...
void HitBadguys(bullet_t *me,Map *map,world_t *world)
{
	...
	switch(me->type)
	{
		...
		case BLT_BIGAXE:
			...
			break;
		case BLT_SONIC:
			if(FindVictims(me->x>>FIXSHIFT,me->y>>FIXSHIFT,55,(4-Random(9))<<FIXSHIFT,
				(4-Random(9))<<FIXSHIFT,10*2,map,world,me->friendly,1))
			{
				ExplodeParticles2(PART_SNOW2,me->x,me->y,me->z,10,8);
			}
			break;
...
void UpdateBullet(bullet_t *me,Map *map,world_t *world)
{
	...
	switch(me->type)
	{
		...
		case BLT_SONIC:
			...
			{
				FireExactBullet(me->x+Cosine(me->facing)*16,me->y+Sine(me->facing)*16,FIXAMT*20,0,0,0,me->anim-1,4,me->facing,BLT_SONIC,me->friendly);
				HitBadguys(me,map,world);
			}
			break;
		case BLT_BIGSHELL:
...
void FireMe(bullet_t *me,int x,int y,byte facing,byte type,byte friendly)
{
	...
	switch(me->type)
	{
		...
		case BLT_SPARKSHOT:
			...
			SetBulletVars(me,2,0,me->z,80,BD_NONE);
			me->target=65535;
			break;
		case BLT_SCANNER:
		...
		case BLT_SONIC:
			me->anim=4;
			SetBulletVars(me,0,0,FIXAMT*20,4,BD_NONE);
			break;
		case BLT_LIGHTNING:
		case BLT_LIGHTNING2:
			me->timer=2;
		...
		case BLT_ORBITER2:
			...
			break;
		case BLT_MINDWIPE:
			SetBulletVars(me,10,0,FIXAMT*20,40,BD_EIGHT);
			break;
		case BLT_PAPER:
